...
angular.module("xReadingList").controller("DetailsController",["$http","$location","$anchorScroll",function(t,s,l){"use strict";var i=this;i.issue={},i.showDetails=!1,i.lastId=null,i.urls=[],i.coverRoot="http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available",i.extension="jpg",i.getDetails=function(o,e){o._id!==i.lastId?(s.hash(e+"-details"),l(),i.showDetails=!0,i.lastId=o._id,i.coverRoot=o.coverRoot,i.extension=o.extension,i.urls=o.urls,t.post("/details",{id:o._id}).success(function(t){t.length>0&&(i.issue=t[0])})):(i.showDetails=!1,i.lastId=null)}}]);
