...
k.thumbnail.path;d[f].extension=k.thumbnail.extension;d[f].urls=mapUrls(k.urls);break}b.data.offset+b.data.count<b.data.total&&b.data.limit===b.data.count&&1E3>e&&g(a,c,e,d)}}function g(a,c,d,g){b.get("http://gateway.marvel.com:80/v1/public/comics?title="+a+"&startYear="+c+"&formatType=comic&offset="+d+"&limit=100&noVariants=true&apikey=2c7b5e832ec9ddc7c4dc4e432f24fbb4",{cache:!0}).success(e(a,c,g,d))}return{getMarvelData:function(a){b.get("http://gateway.marvel.com:80/v1/public/comics?title="+a.series+
"&startYear="+a.volume+"&issueNumber="+a.number+"&noVariants=true&apikey=2c7b5e832ec9ddc7c4dc4e432f24fbb4",{cache:!0}).success(l(a))},getMarvelVolumeData:g}}]);
