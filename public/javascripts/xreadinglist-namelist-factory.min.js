...
angular.module("xReadingList").factory("NameList",["$http","$filter",function(d,b){return{CreateList:function(f,g){var a=this;a.title=f;a.names=[];a.allOf=[];a.anyOf=[];a.excluded=[];a.selecting=!1;a.hasAllColumn=g;a.limit=50;a.displayList=[];a.searchText="";d.post("/list",{listName:f,cache:!0}).success(function(c){c&&0<c.length&&(a.names=c[0].names,a.names.sort())});this.updateDisplayList=function(){a.displayList=a.searchText?b("filter")(a.names,a.searchText):a.names;a.displayList=b("limitTo")(a.displayList,
